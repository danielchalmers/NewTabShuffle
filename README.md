...
A browser extension that randomly displays URLs or local files every time you open a new tab.
...
<!-- List features briefly here -->

## 📖 Usage

<!-- Describe usage briefly here -->

## 🙏 Credits

<!-- List all third party licenses here -->
